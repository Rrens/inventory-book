                                    ...
                                    <tbody>
                                        @foreach ($data as $item)
                                            <tr>
                                                ...
                                                <td class="text-bold-500">
                                                    {{-- Ready --}}
                                                    {{ (empty($peminjaman->where('id_buku', $item->id)->latest()->first()['keterangan'])? '': $peminjaman->where('id_buku', $item->id)->latest()->first()['keterangan'] == 'pinjam')? 'Tidak tersedia': 'Tersedia' }}
                                                </td>
                                                <td>
